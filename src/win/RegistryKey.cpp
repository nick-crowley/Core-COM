...
RegistryKey::RegistryKey(open_existing_t, SharedRegistryKey handle, REGSAM rights, 
	std::shared_ptr<RegistryApi> api)
	: m_api{ThrowIfEmpty(api)}, m_key{handle}, m_rights{rights}
{
}

RegistryKey::RegistryKey(open_existing_t, RegistryKey const& key, REGSAM rights, std::shared_ptr<RegistryApi> api)
	: RegistryKey{open_existing, key.m_key, rights, api}
{
}

RegistryKey::RegistryKey(open_existing_t, SharedRegistryKey parent, std::wstring_view child, REGSAM rights, 
	std::shared_ptr<RegistryApi> api)
	: m_api{ThrowIfEmpty(api)}, m_key{api->open_key(parent, child, rights)}, m_rights{rights}
{
}

RegistryKey::RegistryKey(open_existing_t, RegistryKey const& key, std::wstring_view child, REGSAM rights, 
	std::shared_ptr<RegistryApi> api)
	: RegistryKey{open_existing, key.m_key, child, rights, api}
{
}

RegistryKey::RegistryKey(create_new_t, SharedRegistryKey parent, std::wstring_view child, REGSAM rights, 
	std::shared_ptr<RegistryApi> api)
	: m_api{ThrowIfEmpty(api)}, m_key{api->create_key(parent, child, rights)}, m_rights{rights}
{
}

RegistryKey::RegistryKey(create_new_t, RegistryKey const& parent, std::wstring_view child, REGSAM rights, 
	std::shared_ptr<RegistryApi> api)
	: RegistryKey{create_new, parent.m_key, child, rights, api}
{
}
